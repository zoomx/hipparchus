...
public class Orchestrator extends Application{
    ...
    public static String starLabelNamesArray[] = {
        "Acubens (á-Cnc)", "Al Nair (á-Gru)", "Albireo (â-Cyg)",
        "Aldebaran (á-Tau)", "Algenib (ã-Peg)", "Algieba (ã-Leo)",
        "Alphard (á-Hya)", "Alpheratz (á-And)", "Alrescha (á-Pcs)",
        "Antares (á-Sco)", "Arneb (á-Lep)", "Bellatrix (ã-Ori)",
        "Betelgeus (á-Ori)", "Canopus (á-Car)", "Capella (á-Aur)",
        "Castor (á-Gem)", "Cor Caroli (á-Cvn)", "Deneb (á-Cyg)",
        "Denebola (â-Leo)", "Diphda (â-Cet)", "Dubhe (á-UMa)",
        "Fomalhaut (á-Psa)", "Hamal (á-Ari)", "Kraz (â-Crv)",
        "Markab (á-Peg)", "Menkar (á-Cet)", "Merak (â-UMa)",
        "Mirach (â-And)", "Mirfak (á-Per)", "Nunki (ó-Sgr)",
        "Phact (á-Col)", "Polaris (á-UMi)", "Pollux (â-Gem)",
        "Porrima (ã-Vir)", "Procyon (á-CMi)", "Ras Algethi (á-Her)",
        "Regor (ã-Vel)", "Regulus (á-Leo)", "Rigel (â-Ori)",
        "Sadachbia (ã-Aqr)", "Sadalmelik (á-Aqr)", "Scheat (â-Peg)",
        "Schedar (á-Cas)", "Schaula (ë-Sco)", "Sirius (á-CMa)",
        "Spica (á-Vir)", "Suhail (ë-Vel)", "Thuban (á-Dra)",
        "Unukalhai (á-Ser)", "Vega (á-Lyr)", "Vindemiatrix (å-Vir)"};
